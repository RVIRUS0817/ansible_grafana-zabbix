...
token="https://hooks.slack.com/services/xxxxxxxxxxxxxxxxxxxxxxxxx"
strSubject="$2"
...
/usr/bin/curl -m 5 --data-urlencode "${payload}" 'https://hooks.slack.com/services/xxxxxxxxxxxxxxxxxxxxxxx'
